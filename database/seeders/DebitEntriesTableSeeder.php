...
class DebitEntriesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        \DB::table('debit_entries')->delete();
        
        \DB::table('debit_entries')->insert(array (
            0 => 
            array (
                'id' => 1,
